...
df_clean_sub['MeasureName'] = df_clean_sub['MeasureName'].str.replace(" ","").str.replace("(","").str.replace(")","")
df_dirty_sub['MeasureName'] = df_dirty_sub['MeasureName'].str.replace(" ","").str.replace("(","").str.replace(")","")
...
db_row_val = pred_content_list[0]  #IS OF TYPE STR
print "DB Row Value: " + db_row_val
db_mln_cell_val = pred_content_list[1]
print "MLN Generated Value: " + db_mln_cell_val #IS OF TYPE STR


#Types of column values: based on df_dirty_sub
#ProviderNumber - numpy.int64
#HospitalName - str
#City - str
#State - str
#ZipCode - numpy.int64
#CountyName - str
#PhoneNumber - numpy.int64
#MeasureCode - str
#MeasureName - str
...
change = pd.DataFrame({'from':change_from, 'to':change_to})
print change
